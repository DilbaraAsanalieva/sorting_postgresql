...
SELECT * FROM students WHERE age <= 40 AND age <= 30;
SELECT * FROM students WHERE age = 30;
SELECT * FROM students WHERE university = 'Universität Erfurt';

SELECT university,COUNT(*)FROM students group by  university order by count(*) desc ;
SELECT * FROM students WHERE university = 'Capital University of Medical Sciences';
SELECT id as student_id,first_name,last_name as surname,university FROM students WHERE university = 'Capital University of Medical Sciences';
...
SELECT count(*) FROM students WHERE first_name LIKE 'K%'; --just count
SELECT * FROM students WHERE first_name ILIKE 'kA%';

SELECT * FROM students where first_name like '_e%'; --2-тамга
SELECT * FROM students where first_name like '%e';--акыркы
SELECT * FROM students where first_name like '%e_'; --перед последний

SELECT * FROM students WHERE first_name ILIKE 'E%' AND first_name ILIKE '%E';

SELECT  * FROM students WHERE university in ('Universidad Autónoma de Guerrero',
                                             'University of Jazeera',
                                             'Central Queensland University'); -- means OR


SELECT * FROM students WHERE age BETWEEN 30 AND 40;

SELECT * FROM students WHERE age > (SELECT  round(avg(age)) FROM students); --БОЛЬШЕ СРЕДНЕГО ВОЗРOСТА

SELECT  first_name, age - (SELECT  round(avg(age)) FROM students) as diff_age_with_avg FROM students; --IMPORTANT

SELECT * FROM students ORDER BY  first_name desc ;--Z акыркы
SELECT * FROM students ORDER BY  first_name asc ; --A баштапкы
